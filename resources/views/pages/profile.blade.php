    ...
    <div class="container-fluid px-2 px-md-4">
        ...
        <div class="row mt-4">
            <div class="col col-md-6">
                <div class="card">
                    <form action="/profile/credentials/{{ Auth::user()->id }}" method="POST">
                        <div class="card-header text-uppercase text-sm text-bold">
                            Change credentials
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn bg-gradient-primary me-4">Change Credentials</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="input-group input-group-static my-2">
                                    ...
                                    <input type="password" name="verifyNewPassword" class="form-control" required
                                        onchange="onChange()" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn bg-gradient-primary me-4">Change Password</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('custom_script')
    <script>
        function onChange() {
            ...
            const confirm = document.querySelector('input[name=verifyNewPassword]');
