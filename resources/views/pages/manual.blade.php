                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                            <h4 class="text-white font-weight-bolder text-center mt-0 mb-0">Employee List</h4>
                            {{-- <div class="row mt-3">
                    ...
                    <div class="card-body">
                        <form role="form" class="text-start" id="input_id" action="/absen/manual" method="post">
                            @csrf
                            ...
                            <div class="input-group input-group-outline row">
                                <label for="id" class="">Select employee name</label>
                                <select name="id" class="form-control ms-3" id="id" required>
                                    <option hidden disabled selected>--- SELECT ONE ---</option>
                                    {{-- <option value="1">Hansen Alexander Rustan</option> --}}
