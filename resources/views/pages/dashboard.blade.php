        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-xl-0 mb-4">
            <div class="card">
                <div class="p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Kunjungan Hari Ini</p>
                ...
                <div class="card-footer p-3 d-flex">
                    <i class="material-icons text-sm my-auto me-1">schedule</i>
                    <p class="mb-0 text-sm">last access {{ $lastScan }}</p>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-xl-0 mb-4">
            <div class="card">
                ...
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3 d-flex">
                    <i class="material-icons text-sm my-auto me-1">data_thresholding</i>
                    <p class="mb-0 text-sm">Total kunjungan tahun ini sebanyak {{ $thisYearTotal }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-6 col-md-6 mt-4 mb-4">
            <div class="card z-index-2 ">
                ...
                <div class="card-body">
                    <h6 class="mb-0 ">Grafik Kunjungan Seminggu</h6>
                    {{-- <p class="text-sm ">Last Campaign Performance</p> --}}
                    <hr class="dark horizontal">
                    <div class="d-flex ">
                        <i class="material-icons text-sm my-auto me-1">schedule</i>
                        <p class="mb-0 text-sm">last update {{ date('d M Y h:i:s') }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 mt-4 mb-4">
            <div class="card z-index-2  ">
                ...
                <div class="card-body">
                    <h6 class="mb-0 "> Grafik Kunjungan Bulanan </h6>
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @php $i = 1; @endphp
                                @foreach ($tableNewest as $row)
                                    <tr>
                                        <td>
                                            <div class="px-2 py-1">
                                                <div class="d-flex flex-column">
                                                    <p class="mb-0 text-sm text-center text-bold">{{ $i }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
        ...
        new Chart(ctx2, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    fill: true,
                    data: [
                        @foreach ($monthCountHistory as $value)
                            {{ $value . ', ' }}
                        @endforeach
                    ],
                    maxBarThickness: 6
